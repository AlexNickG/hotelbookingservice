package com.example.hotelbookingservice.kafka.configuration;
...
public class KafkaConfiguration {
    ...
    @Value("@{app.kafka.registerUserGroupId}")
    private String registerUserGroupId;
    ...
    public <T> ConsumerFactory<String, T> kafkaMessageConsumerFactory(ObjectMapper objectMapper) {
        ...
        config.put(ConsumerConfig.GROUP_ID_CONFIG, registerUserGroupId);
